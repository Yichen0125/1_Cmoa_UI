...
<head>
 <c:set var="ctp" value="${pageContext.request.contextPath }" scope="session"></c:set>
    <meta charset="utf-8">
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="static/dist/css/ionicons-2.0.1/css/ionicons.min.css">
    <!-- Theme style -->
  ...
  <![endif]-->
    <link rel="stylesheet" href="static/dist/css/userDefined.css">
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <script src="static/dist/js/userDefined.js"></script>
    <script src="static/dist/js/ztree.js"></script>
</body>
